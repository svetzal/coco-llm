...
![An illustration on the CoCo's green screen: a wireframe box in oblique view holding about thirty points, each with a dashed drop line to the floor. Six larger amber points sit close together and are labelled ACORN, APPLE, ATARI, COMMODORE, SINCLAIR and TANDY; the rest are small black points spread through the other side of the box. A caption at the bottom reads: tokens that are followed by the same kind of token end up near each other.](images/points-in-a-box-concept.png)
