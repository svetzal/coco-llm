...
def main() -> None:
    ...
    if arguments.experiment == 4:
        criteria = [
            ...
            "same_seed_first equ     $0420",
            "before_first    equ     $0440",
            "untrained_seed  equ     $0460",
            "untrained_first equ     $0466",
            "after_first     equ     $0480",
            "trained_seed    equ     $04a0",
            "sample_1_first  equ     $04a6",
            "sample_2_first  equ     $04c6",
            "sample_3_first  equ     $04e6",
            "sample_4_first  equ     $0506",
            "sample_5_first  equ     $0526",
            "sample_10_last  equ     $05df",
            ";! parity_result = #$01",
            ";! mismatch_offset = #$ffff",
            ";! mismatch_actual = #$00",
            ";! mismatch_expect = #$00",
            ";! last_epoch = #20",
            "; The final screen compares identical seed 6809 before and after training.",
            ";! title_first = #$1412",
            ";! same_seed_first = #$5341",
            ";! before_first = #$4245",
            ";! untrained_seed = #$6360",
            ";! untrained_first = #$3830",
            ";! after_first = #$4146",
            ";! trained_seed = #$6360",
        ...
        criteria = [
            ...
            ";! mismatch_expect = #$00",
            ";! last_epoch = #80",
            "; SAME MODEL - CHANGE THE PROMPT; UP/DOWN SELECT, ENTER GENERATE.",
            ";! title_first = #$1301",
            ";! instruction = #$5550",
