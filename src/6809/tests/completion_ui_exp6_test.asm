...
exp6_ui_copy_phrase
        ...
        ldd     COMPLETION_INPUT_SCREEN
        cmpd    #$5052                 ; "PR" | $40
        lbne    exp6_ui_test_failed
        ldx     completion_popover_origin
        cmpx    completion_input_cursor
        lbne    exp6_ui_test_failed
        lda     completion_popover_width
        ...
        lbne    exp6_ui_test_failed
        lda     completion_suggestions_visible
        cmpa    #1
        lbne    exp6_ui_test_failed
        ...
        ldd     #COMPLETION_SCREEN+158        ; row four, column 30
        std     completion_input_cursor
        lbsr    completion_draw_suggestions
        lda     completion_popover_origin+1
        anda    #$1f
        ...
        andb    #$e0
        cmpd    #COMPLETION_SCREEN+128
        lbne    exp6_ui_test_failed
        lbsr    completion_hide_suggestions

        ; At the bottom-right corner, the box shifts both left and upward.
        lda     COMPLETION_SCREEN+511
        sta     exp6_ui_saved_corner
        ldd     #COMPLETION_SCREEN+510
        std     completion_input_cursor
        lbsr    completion_draw_suggestions
        ldd     completion_popover_origin
        andb    #$e0
        cmpd    #COMPLETION_SCREEN+416        ; last legal start row for height three
        lbne    exp6_ui_test_failed
        lda     completion_popover_origin+1
        anda    #$1f
        adda    completion_popover_width
        ...
        cmpa    #22
        lbne    exp6_ui_test_failed
        ldd     completion_input_buffer+13
        cmpd    #$434f                 ; "CO"
        lbne    exp6_ui_test_failed
        lda     completion_input_buffer+21
        cmpa    #$20
        lbne    exp6_ui_test_failed
...
exp6_ui_copy_wrap_phrase
        ...
        clr     ,u
        lbsr    completion_draw_input
        lda     COMPLETION_INPUT_SCREEN+30
        cmpa    #$60                   ; unused tail of the first row
        lbne    exp6_ui_test_failed
        ldd     COMPLETION_INPUT_SCREEN+32
        cmpd    #$574f                 ; "WO" begins the second row
        lbne    exp6_ui_test_failed
        ldd     COMPLETION_INPUT_SCREEN+34
        cmpd    #$5244                 ; the complete word remains intact
        lbne    exp6_ui_test_failed
        lda     COMPLETION_INPUT_SCREEN+36
...
exp6_ui_fill_row_word
        ...
        clr     ,u
        lda     #170
        sta     completion_input_length
        lbsr    completion_draw_input
        lda     COMPLETION_INPUT_END-32
        cmpa    #$41                   ; text reaches screen row eleven
        lbne    exp6_ui_test_failed
        lda     COMPLETION_INPUT_END-15
        cmpa    #$20                   ; cursor remains on the final text row
        lbne    exp6_ui_test_failed
        lda     COMPLETION_INPUT_END
